...
const items = [
  <div>
    <div className="carousel-item">
      <img src={firstProduct} onDragStart={handleDragStart} role="presentation" />
    </div>
  </div>,
  <div>
    <div className="carousel-item">
      <img src={secondProduct} onDragStart={handleDragStart} role="presentation" />
    </div>
  </div>,
  <div>
    <div className="carousel-item">
      <img src={thirdProduct} onDragStart={handleDragStart} role="presentation" />
    </div>
  </div>
];
  ...
  return (
    <div className="grid grid-cols-4 gap-4">
      <div className="bg-white rounded-[5px] ">
        <div>
        <AliceCarousel mouseTracking items={items} autoPlayControls={false} // Disable auto play controls
  />
